...
// const tradatoken_artifacts = require('../../../../build/contracts/TradaToken.json');
// @Component({
...
//         });
//       });
//       // artifacts TradaToken
//       this.web3Service.artifactsToContract(tradatoken_artifacts)
//       .then((TradaTokenAbstraction) => {
//         this.TradaToken = TradaTokenAbstraction;
//         this.TradaToken.deployed().then(deployed => {
//           deployed.Transfer({}, (err, ev) => {
//             this.refreshBalance();
//           });
//         });
